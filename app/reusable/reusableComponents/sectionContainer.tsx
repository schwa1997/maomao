  ...
  return (
    <Container>
      ...
      >
        ...
        >
          <h2
            className={`text-2xl font-bold text-black dark:text-white inline-block border-b-2 ${
              isHovered
                ? "border-pink dark:border-darkPink"
          ...
          <button
            ...
            className={`p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-all duration-300 ${
              isOpen ? "opacity-100" : "opacity-100 absolute right-8"
            }`}
        ...
        <div
          className={`transition-all duration-300 ease-in-out overflow-hidden  ${
            isOpen ? "mt-8 opacity-100 max-h-[2000px]" : "opacity-0 max-h-0"
          }`}
        >
          {children}
        </div>
